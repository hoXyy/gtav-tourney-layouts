              ...
              for (let i = 0; i < parsed.data.length; i++) {
                ...
                if (
                  ...
                  if (parsed.data[i].place % 10 === 1) {
                    pb1_string = time + ` (` + parsed.data[i].place + `st)`;
                  } else if (parsed.data[i].place % 10 === 2) {
                    pb1_string = time + ` (` + parsed.data[i].place + `nd)`;
                  } else if (parsed.data[i].place % 10 === 3) {
                    pb1_string = time + ` (` + parsed.data[i].place + `rd)`;
                  } else {
                    pb1_string = time + ` (` + parsed.data[i].place + `th)`;
                  }
            ...
            .then((res) => {
              ...
              for (let i = 0; i < parsed.data.length; i++) {
                ...
                if (
                  ...
                  nopb = false;
                  if (parsed.data[i].place % 10 === 1) {
                    pb2_string = time + ` (` + parsed.data[i].place + `st)`;
                  } else if (parsed.data[i].place % 10 === 2) {
                    pb2_string = time + ` (` + parsed.data[i].place + `nd)`;
                  } else if (parsed.data[i].place % 10 === 3) {
                    pb2_string = time + ` (` + parsed.data[i].place + `rd)`;
                  } else {
                    pb2_string = time + ` (` + parsed.data[i].place + `th)`;
                  }
